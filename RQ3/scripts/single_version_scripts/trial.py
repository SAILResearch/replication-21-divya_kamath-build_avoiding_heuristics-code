...
project_list = ['opal', 'gradle', 'geoserver', 'cloudify', 'vagrant']
project_list = ['orbeon-forms']
# In[95]:
...
def bootstrapping(p_name):
    ...
    for train_val in range(300, 700, 100)[:1]:
        ...
        #     print(list(project['tr_status']))
            ...
            while start_date < end_date:
                ...
                while True:
                    ...
                    if test_end > end_date:
                        ...
                        if len(train_result) == 0:
                            ...
                            train_start = train_end - datetime.timedelta(days = train_period)

                            train_data = project[ (project['gh_build_started_at'] > train_start) & (project['gh_build_started_at'] < train_end)]
                            train_result = train_data['tr_status'].tolist()
                        break
                ...
                total_train_length += len(train_result)
                total_test_length += len(test_result)
                ...
                for i in range(1):
                    ...
                    print(sample_test, sample_pred_vals)
        ...
        #         print(len(ci))
            ...
            res_file = p_name + '_result.txt'
            with open(res_file, 'a+') as fres:
                fres.write("Training period in {} = {} \n".format(p_name, train_val))
                ...
                fres.write("Total Train & Test lengths = {}, {}".format(total_train_length, total_test_length))
            ...
            print("Total Train & Test lengths = {}, {}".format(total_train_length, total_test_length))
            print('\n\n\n\n\n')
...
return_vals = []
with Pool(9) as pool:
    return_vals.append(pool.map(bootstrapping, project_list))
