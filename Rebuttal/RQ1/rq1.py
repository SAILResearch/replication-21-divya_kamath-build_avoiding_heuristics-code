...
project_list = ['gradle.csv', 'jruby.csv', 'metasploit-framework.csv', 'cloudify.csv', 'vagrant.csv', 'rubinius.csv', 'open-build-service.csv', 'sonarqube.csv', 'loomio.csv', 'fog.csv', 'opal.csv', 'cloud_controller_ng.csv', 'puppet.csv', 'concerto.csv', 'sufia.csv', 'geoserver.csv', 'orbeon-forms.csv', 'graylog2-server.csv', 'rails.csv', 'heroku.csv']
...
def bootstrapping(p_name, train_data, count):
    ...
    file_name = 'dump_data/rq1_' + p_name + '_' + str(count) + '_best_model.pkl'
